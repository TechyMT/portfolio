...
const ProfileText = ({ visible, titleId }) => (
  <Fragment>
    ...
    <Text className={styles.description} data-visible={visible} size="l" as="p">
      ...
      travel. I’m always down for hearing about new projects, so feel free to drop me a
      line.
    </Text>
  </Fragment>
);
          ...
          <div className={styles.content} ref={nodeRef}>
            ...
            <div className={styles.column}>
              ...
              <div className={styles.image}>
                ...
                />
                <svg className={styles.svg} data-visible={visible} viewBox="0 0 321 938">
                  <use href={`${katakana}#profile`} />
                </svg>
              </div>
            </div>
          </div>
