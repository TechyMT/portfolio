...
const name = 'Mustafa Trunkwala';
const instahandle = '@nothim_7856';
...
export const Meta = ({ title, description, prefix = name, ogImage = defaultOgImage }) => {
  ...
  return (
    <Head>
      ...
      <meta name="instagram:title" content={titleText} />
      <meta name="instagram:site" content={instahandle} />
      <meta name="instagram:creator" content={instahandle} />
